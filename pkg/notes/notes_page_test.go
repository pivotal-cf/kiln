...
func TestParseNotesPage(t *testing.T) {
	...
	alreadyPublishedReleaseNotesData := Data{
		...
		Components: []BOSHReleaseData{
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "backup-and-restore-sdk", Version: "1.18.26"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "binary-offline-buildpack", Version: "1.0.40"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "bosh-dns-aliases", Version: "0.0.3"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "bosh-system-metrics-forwarder", Version: "0.0.20"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "bpm", Version: "1.1.15"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "capi", Version: "1.84.20"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "cf-autoscaling", Version: "241"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "cf-backup-and-restore", Version: "0.0.11"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "cf-cli", Version: "1.32.0"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "cf-networking", Version: "2.40.0"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "cf-smoke-tests", Version: "40.0.134"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "cf-syslog-drain", Version: "10.2.5"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "cflinuxfs3", Version: "0.264.0"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "credhub", Version: "2.5.13"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "diego", Version: "2.53.0"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "dotnet-core-offline-buildpack", Version: "2.3.36"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "garden-runc", Version: "1.19.30"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "go-offline-buildpack", Version: "1.9.37"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "haproxy", Version: "9.6.1"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "istio", Version: "1.3.0"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "java-offline-buildpack", Version: "4.42"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "leadership-election", Version: "1.4.2"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "log-cache", Version: "2.1.17"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "loggregator-agent", Version: "3.21.18"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "loggregator", Version: "105.6.8"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "mapfs", Version: "1.2.4"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "metric-registrar", Version: "1.1.9"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "mysql-monitoring", Version: "9.7.0"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "nats", Version: "40"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "nfs-volume", Version: "2.3.10"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "nginx-offline-buildpack", Version: "1.1.32"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "nodejs-offline-buildpack", Version: "1.7.63"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "notifications-ui", Version: "39"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "notifications", Version: "62"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "php-offline-buildpack", Version: "4.4.48"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "push-apps-manager-release", Version: "670.0.29"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "push-usage-service-release", Version: "670.0.36"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "pxc", Version: "0.39.0"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "python-offline-buildpack", Version: "1.7.47"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "r-offline-buildpack", Version: "1.1.23"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "routing", Version: "0.226.0"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "ruby-offline-buildpack", Version: "1.8.48"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "silk", Version: "2.40.0"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "smb-volume", Version: "3.0.1"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "staticfile-offline-buildpack", Version: "1.5.26"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "statsd-injector", Version: "1.11.16"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "syslog", Version: "11.7.5"}},
			{BOSHReleaseLock: cargo.BOSHReleaseLock{Name: "uaa", Version: "73.4.32"}},
		},
