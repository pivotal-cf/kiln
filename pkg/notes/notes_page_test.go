...
func TestParseNotesPage(t *testing.T) {
	...
	alreadyPublishedReleaseNotesData := Data{
		...
		Components: []ComponentData{
			{ReleaseLock: cargo.ReleaseLock{Name: "backup-and-restore-sdk", Version: "1.18.26"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "binary-offline-buildpack", Version: "1.0.40"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "bosh-dns-aliases", Version: "0.0.3"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "bosh-system-metrics-forwarder", Version: "0.0.20"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "bpm", Version: "1.1.15"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "capi", Version: "1.84.20"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "cf-autoscaling", Version: "241"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "cf-backup-and-restore", Version: "0.0.11"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "cf-cli", Version: "1.32.0"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "cf-networking", Version: "2.40.0"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "cf-smoke-tests", Version: "40.0.134"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "cf-syslog-drain", Version: "10.2.5"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "cflinuxfs3", Version: "0.264.0"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "credhub", Version: "2.5.13"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "diego", Version: "2.53.0"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "dotnet-core-offline-buildpack", Version: "2.3.36"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "garden-runc", Version: "1.19.30"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "go-offline-buildpack", Version: "1.9.37"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "haproxy", Version: "9.6.1"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "istio", Version: "1.3.0"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "java-offline-buildpack", Version: "4.42"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "leadership-election", Version: "1.4.2"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "log-cache", Version: "2.1.17"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "loggregator-agent", Version: "3.21.18"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "loggregator", Version: "105.6.8"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "mapfs", Version: "1.2.4"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "metric-registrar", Version: "1.1.9"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "mysql-monitoring", Version: "9.7.0"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "nats", Version: "40"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "nfs-volume", Version: "2.3.10"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "nginx-offline-buildpack", Version: "1.1.32"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "nodejs-offline-buildpack", Version: "1.7.63"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "notifications-ui", Version: "39"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "notifications", Version: "62"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "php-offline-buildpack", Version: "4.4.48"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "push-apps-manager-release", Version: "670.0.29"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "push-usage-service-release", Version: "670.0.36"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "pxc", Version: "0.39.0"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "python-offline-buildpack", Version: "1.7.47"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "r-offline-buildpack", Version: "1.1.23"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "routing", Version: "0.226.0"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "ruby-offline-buildpack", Version: "1.8.48"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "silk", Version: "2.40.0"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "smb-volume", Version: "3.0.1"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "staticfile-offline-buildpack", Version: "1.5.26"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "statsd-injector", Version: "1.11.16"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "syslog", Version: "11.7.5"}},
			{ReleaseLock: cargo.ReleaseLock{Name: "uaa", Version: "73.4.32"}},
		},
		Bumps: BumpList{
...
func TestParseNotesPageWithExpressionAndReleasesSentinel(t *testing.T) {
	...
	t.Run("multiple releases", func(t *testing.T) {
		...
		please.Expect(page.Releases).To(Equal([]TileVersionNote{
			{Version: "1", Notes: "r1."},
			{Version: "2", Notes: "r2.."},
			{Version: "3", Notes: "r3"},
			{Version: "4", Notes: "r4..."},
...
func TestReleaseNotesPage_Add(t *testing.T) {
	...
	//   func (page Page) Add(note TileVersionNote) (int, error)
	...
	t.Run("initial release", func(t *testing.T) {
		...
		note := TileVersionNote{Version: "1", Notes: "r1"}
		err := page.Add(note)
		please.Expect(err).NotTo(HaveOccurred())
	...
	t.Run("new latest release", func(t *testing.T) {
		...
		page := Page{
			...
			Releases: []TileVersionNote{
				{Version: "2", Notes: "r2"},
			},
		}
		newNote := TileVersionNote{Version: "3", Notes: "r3"}
	...
	t.Run("update existing release notes", func(t *testing.T) {
		...
		newNote := TileVersionNote{Version: "1", Notes: "r2"}
		err := page.Add(newNote)
		please.Expect(err).NotTo(HaveOccurred())
		please.Expect(page.Releases).To(Equal([]TileVersionNote{
			{Version: "1", Notes: "r2"},
	...
	t.Run("insert between", func(t *testing.T) {
		...
		newNote := TileVersionNote{Version: "2", Notes: "r2"}
		err := page.Add(newNote)
		please.Expect(err).NotTo(HaveOccurred())
		please.Expect(page.Releases).To(Equal([]TileVersionNote{
			{Version: "3", Notes: "r3"},
	...
	t.Run("notes version field is invalid", func(t *testing.T) {
		...
		newNote := TileVersionNote{Version: "s", Notes: "r2"}
		err := page.Add(newNote)
		please.Expect(err).To(HaveOccurred())
	})
	t.Run("add notes to end", func(t *testing.T) {
		...
		newNote := TileVersionNote{Version: "1", Notes: "r1"}
		err := page.Add(newNote)
		please.Expect(err).NotTo(HaveOccurred())
		please.Expect(page.Releases).To(Equal([]TileVersionNote{
			{Version: "3", Notes: "r3"},
	...
	t.Run("notes content does not match page regex", func(t *testing.T) {
		...
		newNote := TileVersionNote{Version: "2", Notes: "s2"}
		err := page.Add(newNote)
		please.Expect(err).To(HaveOccurred())
	})
}
