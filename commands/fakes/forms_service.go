...
func (fake *FormsService) FromDirectories(arg1 []string) (map[string]interface{}, error) {
	var arg1Copy []string
	if arg1 != nil {
...
func (fake *FormsService) FromDirectoriesCalls(stub func([]string) (map[string]interface{}, error)) {
	fake.fromDirectoriesMutex.Lock()
