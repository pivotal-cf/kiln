...
type LocalReleaseDirectory struct {
	DeleteExtraReleasesStub        func(string, cargo.CompiledReleaseSet, bool) error
	deleteExtraReleasesMutex       sync.RWMutex
	deleteExtraReleasesArgsForCall []struct {
		arg1 string
		arg2 cargo.CompiledReleaseSet
		arg3 bool
	}
	...
	VerifyChecksumsStub        func(string, cargo.CompiledReleaseSet, cargo.AssetsLock) error
...
func (fake *LocalReleaseDirectory) DeleteExtraReleases(arg1 string, arg2 cargo.CompiledReleaseSet, arg3 bool) error {
...
func (fake *LocalReleaseDirectory) DeleteExtraReleasesCalls(stub func(string, cargo.CompiledReleaseSet, bool) error) {
	fake.deleteExtraReleasesMutex.Lock()
	defer fake.deleteExtraReleasesMutex.Unlock()
	fake.DeleteExtraReleasesStub = stub
}

func (fake *LocalReleaseDirectory) DeleteExtraReleasesArgsForCall(i int) (string, cargo.CompiledReleaseSet, bool) {
	fake.deleteExtraReleasesMutex.RLock()
	defer fake.deleteExtraReleasesMutex.RUnlock()
...
func (fake *LocalReleaseDirectory) GetLocalReleases(arg1 string) (cargo.CompiledReleaseSet, error) {
...
func (fake *LocalReleaseDirectory) GetLocalReleasesCalls(stub func(string) (cargo.CompiledReleaseSet, error)) {
	fake.getLocalReleasesMutex.Lock()
...
func (fake *LocalReleaseDirectory) GetLocalReleasesReturns(result1 cargo.CompiledReleaseSet, result2 error) {
	fake.getLocalReleasesMutex.Lock()
	defer fake.getLocalReleasesMutex.Unlock()
...
func (fake *LocalReleaseDirectory) GetLocalReleasesReturnsOnCall(i int, result1 cargo.CompiledReleaseSet, result2 error) {
	fake.getLocalReleasesMutex.Lock()
	defer fake.getLocalReleasesMutex.Unlock()
	fake.GetLocalReleasesStub = nil
...
func (fake *LocalReleaseDirectory) VerifyChecksums(arg1 string, arg2 cargo.CompiledReleaseSet, arg3 cargo.AssetsLock) error {
...
func (fake *LocalReleaseDirectory) VerifyChecksumsCalls(stub func(string, cargo.CompiledReleaseSet, cargo.AssetsLock) error) {
	fake.verifyChecksumsMutex.Lock()
	defer fake.verifyChecksumsMutex.Unlock()
	fake.VerifyChecksumsStub = stub
}

func (fake *LocalReleaseDirectory) VerifyChecksumsArgsForCall(i int) (string, cargo.CompiledReleaseSet, cargo.AssetsLock) {
	fake.verifyChecksumsMutex.RLock()
	defer fake.verifyChecksumsMutex.RUnlock()
