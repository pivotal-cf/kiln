...
type LocalReleaseDirectory struct {
	DeleteExtraReleasesStub        func(string, fetcher.CompiledReleaseSet, bool) error
	...
	GetLocalReleasesStub        func(string) (fetcher.CompiledReleaseSet, error)
	...
	VerifyChecksumsStub        func(string, fetcher.CompiledReleaseSet, cargo.AssetsLock) error
...
func (fake *LocalReleaseDirectory) DeleteExtraReleases(arg1 string, arg2 fetcher.CompiledReleaseSet, arg3 bool) error {
...
func (fake *LocalReleaseDirectory) DeleteExtraReleasesCalls(stub func(string, fetcher.CompiledReleaseSet, bool) error) {
	fake.deleteExtraReleasesMutex.Lock()
	defer fake.deleteExtraReleasesMutex.Unlock()
	fake.DeleteExtraReleasesStub = stub
}

func (fake *LocalReleaseDirectory) DeleteExtraReleasesArgsForCall(i int) (string, fetcher.CompiledReleaseSet, bool) {
	fake.deleteExtraReleasesMutex.RLock()
	defer fake.deleteExtraReleasesMutex.RUnlock()
...
func (fake *LocalReleaseDirectory) GetLocalReleases(arg1 string) (fetcher.CompiledReleaseSet, error) {
...
func (fake *LocalReleaseDirectory) GetLocalReleasesCalls(stub func(string) (fetcher.CompiledReleaseSet, error)) {
	fake.getLocalReleasesMutex.Lock()
...
func (fake *LocalReleaseDirectory) GetLocalReleasesReturns(result1 fetcher.CompiledReleaseSet, result2 error) {
	fake.getLocalReleasesMutex.Lock()
	defer fake.getLocalReleasesMutex.Unlock()
...
func (fake *LocalReleaseDirectory) GetLocalReleasesReturnsOnCall(i int, result1 fetcher.CompiledReleaseSet, result2 error) {
	fake.getLocalReleasesMutex.Lock()
	defer fake.getLocalReleasesMutex.Unlock()
	fake.GetLocalReleasesStub = nil
...
func (fake *LocalReleaseDirectory) VerifyChecksums(arg1 string, arg2 fetcher.CompiledReleaseSet, arg3 cargo.AssetsLock) error {
...
func (fake *LocalReleaseDirectory) VerifyChecksumsCalls(stub func(string, fetcher.CompiledReleaseSet, cargo.AssetsLock) error) {
	fake.verifyChecksumsMutex.Lock()
	defer fake.verifyChecksumsMutex.Unlock()
	fake.VerifyChecksumsStub = stub
}

func (fake *LocalReleaseDirectory) VerifyChecksumsArgsForCall(i int) (string, fetcher.CompiledReleaseSet, cargo.AssetsLock) {
	fake.verifyChecksumsMutex.RLock()
	defer fake.verifyChecksumsMutex.RUnlock()
