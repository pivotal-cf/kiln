...
Currently the releases for the Kilnfile.lock file is can not be generated by kiln.
...
Engineering we use a consourse task in our CI to generate this the Kilnfile.lock
file.
