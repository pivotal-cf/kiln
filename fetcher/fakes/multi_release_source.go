...
type MultiReleaseSource struct {
	DownloadReleaseStub        func(string, release2.Remote, int) (release2.Local, error)
	downloadReleaseMutex       sync.RWMutex
	downloadReleaseArgsForCall []struct {
		arg1 string
		arg2 release2.Remote
		arg3 int
	}
	...
	FindReleaseVersionStub        func(release2.Requirement) (release2.Remote, bool, error)
	...
	GetMatchedReleaseStub        func(release2.Requirement) (release2.Remote, bool, error)
...
func (fake *MultiReleaseSource) DownloadRelease(arg1 string, arg2 release2.Remote, arg3 int) (release2.Local, error) {
...
func (fake *MultiReleaseSource) DownloadReleaseCalls(stub func(string, release2.Remote, int) (release2.Local, error)) {
	fake.downloadReleaseMutex.Lock()
	defer fake.downloadReleaseMutex.Unlock()
	fake.DownloadReleaseStub = stub
}

func (fake *MultiReleaseSource) DownloadReleaseArgsForCall(i int) (string, release2.Remote, int) {
	fake.downloadReleaseMutex.RLock()
	defer fake.downloadReleaseMutex.RUnlock()
...
func (fake *MultiReleaseSource) DownloadReleaseReturns(result1 release2.Local, result2 error) {
	fake.downloadReleaseMutex.Lock()
	defer fake.downloadReleaseMutex.Unlock()
...
func (fake *MultiReleaseSource) DownloadReleaseReturnsOnCall(i int, result1 release2.Local, result2 error) {
	fake.downloadReleaseMutex.Lock()
	defer fake.downloadReleaseMutex.Unlock()
	fake.DownloadReleaseStub = nil
...
func (fake *MultiReleaseSource) FindReleaseVersion(arg1 release2.Requirement) (release2.Remote, bool, error) {
...
func (fake *MultiReleaseSource) FindReleaseVersionCalls(stub func(release2.Requirement) (release2.Remote, bool, error)) {
	fake.findReleaseVersionMutex.Lock()
	defer fake.findReleaseVersionMutex.Unlock()
	fake.FindReleaseVersionStub = stub
}

func (fake *MultiReleaseSource) FindReleaseVersionArgsForCall(i int) release2.Requirement {
	fake.findReleaseVersionMutex.RLock()
	defer fake.findReleaseVersionMutex.RUnlock()
...
func (fake *MultiReleaseSource) FindReleaseVersionReturns(result1 release2.Remote, result2 bool, result3 error) {
	fake.findReleaseVersionMutex.Lock()
	defer fake.findReleaseVersionMutex.Unlock()
...
func (fake *MultiReleaseSource) FindReleaseVersionReturnsOnCall(i int, result1 release2.Remote, result2 bool, result3 error) {
	fake.findReleaseVersionMutex.Lock()
	defer fake.findReleaseVersionMutex.Unlock()
	fake.FindReleaseVersionStub = nil
...
func (fake *MultiReleaseSource) GetMatchedRelease(arg1 release2.Requirement) (release2.Remote, bool, error) {
...
func (fake *MultiReleaseSource) GetMatchedReleaseCalls(stub func(release2.Requirement) (release2.Remote, bool, error)) {
	fake.getMatchedReleaseMutex.Lock()
	defer fake.getMatchedReleaseMutex.Unlock()
	fake.GetMatchedReleaseStub = stub
}

func (fake *MultiReleaseSource) GetMatchedReleaseArgsForCall(i int) release2.Requirement {
	fake.getMatchedReleaseMutex.RLock()
	defer fake.getMatchedReleaseMutex.RUnlock()
...
func (fake *MultiReleaseSource) GetMatchedReleaseReturns(result1 release2.Remote, result2 bool, result3 error) {
	fake.getMatchedReleaseMutex.Lock()
	defer fake.getMatchedReleaseMutex.Unlock()
...
func (fake *MultiReleaseSource) GetMatchedReleaseReturnsOnCall(i int, result1 release2.Remote, result2 bool, result3 error) {
	fake.getMatchedReleaseMutex.Lock()
	defer fake.getMatchedReleaseMutex.Unlock()
	fake.GetMatchedReleaseStub = nil
