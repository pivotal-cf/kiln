...
func (cmd *CacheReleases) uploadLocalRelease(_ context.Context, _ *log.Logger, spec component.Spec, fp string, uploader component.ReleaseUploader) (component.Lock, error) {
