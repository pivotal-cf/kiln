...
func (cmd *CacheCompiledReleases) saveReleaseLocally(director boshdir.Director, relDir string, req component.Requirement, res boshdir.ExportReleaseResult) (string, string, string, error) {
