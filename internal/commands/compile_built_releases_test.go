...
var _ = Describe("CompileBuiltReleases", func() {
	...
	var (
		...
		boshDirector          *commandsFakes.BoshDirector
		boshDeployment1       *commandsFakes.BoshDeployment
	...
	BeforeEach(func() {
		...
		boshDirector = new(commandsFakes.BoshDirector)
		boshDeployment1 = new(commandsFakes.BoshDeployment)
		boshDeployment1.NameReturns("deployment-1")
		boshDeployment2 = new(commandsFakes.BoshDeployment)
		boshDeployment3 = new(commandsFakes.BoshDeployment)
