...
import (
	...
	commands2 "github.com/pivotal-cf/kiln/internal/commands"
	fetcher "github.com/pivotal-cf/kiln/internal/fetcher"
...
var _ = Describe("Find the release version", func() {
	var (
		findReleaseVersion commands2.FindReleaseVersion
		logger             *log.Logger
...
- name: uaac
  source: bosh.io`
		...
		JustBeforeEach(func() {
			...
			findReleaseVersion = commands2.NewFindReleaseVersion(logger, multiReleaseSourceProvider)
