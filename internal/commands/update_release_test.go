...
var _ = Describe("UpdateRelease", func() {
	...
	var (
		...
		expectedRemoteRelease      cargo.BOSHReleaseTarballLock
	...
	Context("Execute", func() {
		BeforeEach(func() {
			...
			expectedDownloadedRelease = component.Local{
				Lock:      cargo.BOSHReleaseTarballLock{Name: releaseName, Version: newReleaseVersion, SHA1: newReleaseSha1},
			...
			exepectedNotDownloadedRelease := cargo.BOSHReleaseTarballLock{
				Name:         releaseName,
		...
		When("none of the release's fields change", func() {
			...
			BeforeEach(func() {
				expectedDownloadedRelease = component.Local{
					Lock:      cargo.BOSHReleaseTarballLock{Name: releaseName, Version: oldReleaseVersion, SHA1: oldReleaseSha1},
					LocalPath: "not-used",
				}
				expectedRemoteRelease = cargo.BOSHReleaseTarballLock{
