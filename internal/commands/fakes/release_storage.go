...
type ReleaseStorage struct {
	...
	FindReleaseVersionStub        func(cargo.BOSHReleaseSpec, bool) (cargo.BOSHReleaseLock, error)
	...
	GetMatchedReleaseStub        func(cargo.BOSHReleaseSpec) (cargo.BOSHReleaseLock, error)
	...
	UploadReleaseStub        func(cargo.BOSHReleaseSpec, io.Reader) (cargo.BOSHReleaseLock, error)
...
func (fake *ReleaseStorage) FindReleaseVersion(arg1 cargo.BOSHReleaseSpec, arg2 bool) (cargo.BOSHReleaseLock, error) {
...
func (fake *ReleaseStorage) FindReleaseVersionCalls(stub func(cargo.BOSHReleaseSpec, bool) (cargo.BOSHReleaseLock, error)) {
	fake.findReleaseVersionMutex.Lock()
	defer fake.findReleaseVersionMutex.Unlock()
	fake.FindReleaseVersionStub = stub
}

func (fake *ReleaseStorage) FindReleaseVersionArgsForCall(i int) (cargo.BOSHReleaseSpec, bool) {
	fake.findReleaseVersionMutex.RLock()
	defer fake.findReleaseVersionMutex.RUnlock()
...
func (fake *ReleaseStorage) GetMatchedRelease(arg1 cargo.BOSHReleaseSpec) (cargo.BOSHReleaseLock, error) {
...
func (fake *ReleaseStorage) GetMatchedReleaseCalls(stub func(cargo.BOSHReleaseSpec) (cargo.BOSHReleaseLock, error)) {
	fake.getMatchedReleaseMutex.Lock()
	defer fake.getMatchedReleaseMutex.Unlock()
	fake.GetMatchedReleaseStub = stub
}

func (fake *ReleaseStorage) GetMatchedReleaseArgsForCall(i int) cargo.BOSHReleaseSpec {
	fake.getMatchedReleaseMutex.RLock()
	defer fake.getMatchedReleaseMutex.RUnlock()
...
func (fake *ReleaseStorage) UploadRelease(arg1 cargo.BOSHReleaseSpec, arg2 io.Reader) (cargo.BOSHReleaseLock, error) {
...
func (fake *ReleaseStorage) UploadReleaseCalls(stub func(cargo.BOSHReleaseSpec, io.Reader) (cargo.BOSHReleaseLock, error)) {
	fake.uploadReleaseMutex.Lock()
	defer fake.uploadReleaseMutex.Unlock()
	fake.UploadReleaseStub = stub
}

func (fake *ReleaseStorage) UploadReleaseArgsForCall(i int) (cargo.BOSHReleaseSpec, io.Reader) {
	fake.uploadReleaseMutex.RLock()
	defer fake.uploadReleaseMutex.RUnlock()
