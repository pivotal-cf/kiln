...
func (fake *VariablesService) FromPathsAndPairs(arg1 []string, arg2 []string) (map[string]interface{}, error) {
	var arg1Copy []string
	if arg1 != nil {
...
func (fake *VariablesService) FromPathsAndPairsCallCount() int {
	fake.fromPathsAndPairsMutex.RLock()
	defer fake.fromPathsAndPairsMutex.RUnlock()
	return len(fake.fromPathsAndPairsArgsForCall)
}

func (fake *VariablesService) FromPathsAndPairsCalls(stub func([]string, []string) (map[string]interface{}, error)) {
	fake.fromPathsAndPairsMutex.Lock()
	defer fake.fromPathsAndPairsMutex.Unlock()
	fake.FromPathsAndPairsStub = stub
}

func (fake *VariablesService) FromPathsAndPairsArgsForCall(i int) ([]string, []string) {
	fake.fromPathsAndPairsMutex.RLock()
	defer fake.fromPathsAndPairsMutex.RUnlock()
...
func (fake *VariablesService) FromPathsAndPairsReturns(result1 map[string]interface{}, result2 error) {
	fake.fromPathsAndPairsMutex.Lock()
	defer fake.fromPathsAndPairsMutex.Unlock()
...
func (fake *VariablesService) FromPathsAndPairsReturnsOnCall(i int, result1 map[string]interface{}, result2 error) {
	fake.fromPathsAndPairsMutex.Lock()
	defer fake.fromPathsAndPairsMutex.Unlock()
	fake.FromPathsAndPairsStub = nil
...
func (fake *VariablesService) Invocations() map[string][][]interface{} {
...
func (fake *VariablesService) recordInvocation(key string, args []interface{}) {
