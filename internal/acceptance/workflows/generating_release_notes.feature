Feature: Generating Release Notes
  Scenario: A milestone is provided
    ...
    And "./scenario/fixtures/release_notes.md.erb" contains substring: The HTML had  inconsistent	 spacing
    And "./scenario/fixtures/release_notes.md.erb" contains substring: ### <a id='0.1.3'></a> 0.1.3
    # TODO: this does not look right. I think it should add the stemcell used by the compiled releases... maybe.
    And "./scenario/fixtures/release_notes.md.erb" contains substring: <tr><td>ubuntu-xenial stemcell</td><td>621.0</td><td></td></tr>
    And "./scenario/fixtures/release_notes.md.erb" contains substring: <tr><td>bpm</td><td>1.1.18</td><td></td></tr>
    And "./scenario/fixtures/release_notes.md.erb" contains substring: <tr><td>hello-release</td><td>0.1.5</td>