...
var _ = Describe("LocalReleaseDirectory", func() {
	...
	Describe("DeleteExtraReleases", func() {
		...
		It("deletes specified files", func() {
			extraReleaseID := cargo.BOSHReleaseTarballSpecification{Name: "extra-release", Version: "0.0"}
		...
		It("sorts the list of releases to be deleted", func() {
			...
			zReleaseID := cargo.BOSHReleaseTarballSpecification{Name: "z-release", Version: "0.0"}
		...
		Context("when a file cannot be removed", func() {
			It("returns an error", func() {
				extraReleaseID := cargo.BOSHReleaseTarballSpecification{Name: "extra-release-that-cannot-be-deleted", Version: "0.0"}
