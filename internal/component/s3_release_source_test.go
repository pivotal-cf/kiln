...
var _ = Describe("S3ReleaseSource", func() {
	...
	Describe("DownloadReleases", func() {
		...
		BeforeEach(func() {
			...
			releaseID = cargo.BOSHReleaseTarballSpecification{Name: "uaa", Version: "1.2.3"}
	...
	Describe("GetMatchedReleases", func() {
		...
		var (
			...
			desiredRelease cargo.BOSHReleaseTarballSpecification
			bpmReleaseID   cargo.BOSHReleaseTarballSpecification
			bpmKey         string
			logger         *log.Logger
		)

		BeforeEach(func() {
			bpmReleaseID = cargo.BOSHReleaseTarballSpecification{Name: "bpm-release", Version: "1.2.3"}
			desiredRelease = cargo.BOSHReleaseTarballSpecification{
				Name:            "bpm-release",
				Version:         "1.2.3",
		...
		It("searches for the requested release", func() {
			...
			_, input, _ := fakeS3Client.HeadObjectArgsForCall(0)
		...
		When("the requested releases doesn't exist in the bucket", func() {
			BeforeEach(func() {
				fakeS3Client.HeadObjectReturns(nil, &s3types.NotFound{})
			})
	...
	Describe("FindReleaseVersion from S3 pcf-final-bosh-releases", func() {
		...
		When("version is semantic and release has version constraint", func() {
			BeforeEach(func() {
				releaseID = cargo.BOSHReleaseTarballSpecification{Name: "uaa", Version: "1.1.1"}
				desiredRelease = cargo.BOSHReleaseTarballSpecification{
					Name:            "uaa",
					Version:         "~1.1",
			...
			It("gets the version that satisfies the constraint", func() {
				...
				_, input, _ := fakeS3Client.ListObjectsV2ArgsForCall(0)
		...
		When("version is a single number", func() {
			BeforeEach(func() {
				releaseID = cargo.BOSHReleaseTarballSpecification{Name: "uaa", Version: "123"}
				desiredRelease = cargo.BOSHReleaseTarballSpecification{
					Name:            "uaa",
					StemcellVersion: "621.71",
				}
	...
	Describe("RemotePath", func() {
		var (
			releaseSource component.S3ReleaseSource
			requirement   cargo.BOSHReleaseTarballSpecification
		)
