...
func (fake *GithubReleaseLister) ListReleases(arg1 context.Context, arg2 string, arg3 string, arg4 *github.ListOptions) ([]*github.RepositoryRelease, *github.Response, error) {
...
func (fake *GithubReleaseLister) ListReleasesCallCount() int {
	fake.listReleasesMutex.RLock()
	defer fake.listReleasesMutex.RUnlock()
	return len(fake.listReleasesArgsForCall)
}

func (fake *GithubReleaseLister) ListReleasesCalls(stub func(context.Context, string, string, *github.ListOptions) ([]*github.RepositoryRelease, *github.Response, error)) {
	fake.listReleasesMutex.Lock()
	defer fake.listReleasesMutex.Unlock()
	fake.ListReleasesStub = stub
}

func (fake *GithubReleaseLister) ListReleasesArgsForCall(i int) (context.Context, string, string, *github.ListOptions) {
	fake.listReleasesMutex.RLock()
	defer fake.listReleasesMutex.RUnlock()
...
func (fake *GithubReleaseLister) ListReleasesReturns(result1 []*github.RepositoryRelease, result2 *github.Response, result3 error) {
	fake.listReleasesMutex.Lock()
	defer fake.listReleasesMutex.Unlock()
...
func (fake *GithubReleaseLister) ListReleasesReturnsOnCall(i int, result1 []*github.RepositoryRelease, result2 *github.Response, result3 error) {
	fake.listReleasesMutex.Lock()
	defer fake.listReleasesMutex.Unlock()
	fake.ListReleasesStub = nil
...
func (fake *GithubReleaseLister) Invocations() map[string][][]interface{} {
...
func (fake *GithubReleaseLister) recordInvocation(key string, args []interface{}) {
...
var _ component.GithubReleaseLister = new(GithubReleaseLister)
