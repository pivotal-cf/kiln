...
func (fake *ReleaseUploader) GetMatchedRelease(arg1 cargo.BOSHReleaseSpec) (cargo.BOSHReleaseLock, error) {
...
func (fake *ReleaseUploader) GetMatchedReleaseCalls(stub func(cargo.BOSHReleaseSpec) (cargo.BOSHReleaseLock, error)) {
	fake.getMatchedReleaseMutex.Lock()
	defer fake.getMatchedReleaseMutex.Unlock()
	fake.GetMatchedReleaseStub = stub
}

func (fake *ReleaseUploader) GetMatchedReleaseArgsForCall(i int) cargo.BOSHReleaseSpec {
	fake.getMatchedReleaseMutex.RLock()
	defer fake.getMatchedReleaseMutex.RUnlock()
...
func (fake *ReleaseUploader) UploadRelease(arg1 cargo.BOSHReleaseSpec, arg2 io.Reader) (cargo.BOSHReleaseLock, error) {
...
func (fake *ReleaseUploader) UploadReleaseCalls(stub func(cargo.BOSHReleaseSpec, io.Reader) (cargo.BOSHReleaseLock, error)) {
	fake.uploadReleaseMutex.Lock()
	defer fake.uploadReleaseMutex.Unlock()
	fake.UploadReleaseStub = stub
}

func (fake *ReleaseUploader) UploadReleaseArgsForCall(i int) (cargo.BOSHReleaseSpec, io.Reader) {
	fake.uploadReleaseMutex.RLock()
	defer fake.uploadReleaseMutex.RUnlock()
