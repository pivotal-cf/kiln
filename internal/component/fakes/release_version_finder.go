...
func (fake *ReleaseVersionFinder) FindReleaseVersion(arg1 cargo.ComponentSpec, arg2 bool) (cargo.ComponentLock, error) {
...
func (fake *ReleaseVersionFinder) FindReleaseVersionCalls(stub func(cargo.ComponentSpec, bool) (cargo.ComponentLock, error)) {
	fake.findReleaseVersionMutex.Lock()
	defer fake.findReleaseVersionMutex.Unlock()
	fake.FindReleaseVersionStub = stub
}

func (fake *ReleaseVersionFinder) FindReleaseVersionArgsForCall(i int) (cargo.ComponentSpec, bool) {
	fake.findReleaseVersionMutex.RLock()
	defer fake.findReleaseVersionMutex.RUnlock()
...
func (fake *ReleaseVersionFinder) FindReleaseVersionReturns(result1 cargo.ComponentLock, result2 error) {
	fake.findReleaseVersionMutex.Lock()
	defer fake.findReleaseVersionMutex.Unlock()
...
func (fake *ReleaseVersionFinder) FindReleaseVersionReturnsOnCall(i int, result1 cargo.ComponentLock, result2 error) {
	fake.findReleaseVersionMutex.Lock()
	defer fake.findReleaseVersionMutex.Unlock()
	fake.FindReleaseVersionStub = nil
