...
func (fake *ReleaseSource) DownloadRelease(arg1 context.Context, arg2 string, arg3 cargo.ComponentLock) (component.Local, error) {
...
func (fake *ReleaseSource) DownloadReleaseCalls(stub func(context.Context, string, cargo.ComponentLock) (component.Local, error)) {
	fake.downloadReleaseMutex.Lock()
	defer fake.downloadReleaseMutex.Unlock()
	fake.DownloadReleaseStub = stub
}

func (fake *ReleaseSource) DownloadReleaseArgsForCall(i int) (context.Context, string, cargo.ComponentLock) {
	fake.downloadReleaseMutex.RLock()
	defer fake.downloadReleaseMutex.RUnlock()
...
func (fake *ReleaseSource) FindReleaseVersion(arg1 context.Context, arg2 cargo.ComponentSpec, arg3 bool) (cargo.ComponentLock, error) {
...
func (fake *ReleaseSource) FindReleaseVersionCalls(stub func(context.Context, cargo.ComponentSpec, bool) (cargo.ComponentLock, error)) {
	fake.findReleaseVersionMutex.Lock()
	defer fake.findReleaseVersionMutex.Unlock()
	fake.FindReleaseVersionStub = stub
}

func (fake *ReleaseSource) FindReleaseVersionArgsForCall(i int) (context.Context, cargo.ComponentSpec, bool) {
	fake.findReleaseVersionMutex.RLock()
	defer fake.findReleaseVersionMutex.RUnlock()
...
func (fake *ReleaseSource) GetMatchedRelease(arg1 context.Context, arg2 cargo.ComponentSpec) (cargo.ComponentLock, error) {
...
func (fake *ReleaseSource) GetMatchedReleaseCalls(stub func(context.Context, cargo.ComponentSpec) (cargo.ComponentLock, error)) {
	fake.getMatchedReleaseMutex.Lock()
	defer fake.getMatchedReleaseMutex.Unlock()
	fake.GetMatchedReleaseStub = stub
}

func (fake *ReleaseSource) GetMatchedReleaseArgsForCall(i int) (context.Context, cargo.ComponentSpec) {
	fake.getMatchedReleaseMutex.RLock()
	defer fake.getMatchedReleaseMutex.RUnlock()
