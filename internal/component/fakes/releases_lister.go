...
func (fake *ReleasesLister) ListReleases(arg1 context.Context, arg2 string, arg3 string, arg4 *github.ListOptions) ([]*github.RepositoryRelease, *github.Response, error) {
...
func (fake *ReleasesLister) ListReleasesCallCount() int {
	fake.listReleasesMutex.RLock()
	defer fake.listReleasesMutex.RUnlock()
	return len(fake.listReleasesArgsForCall)
}

func (fake *ReleasesLister) ListReleasesCalls(stub func(context.Context, string, string, *github.ListOptions) ([]*github.RepositoryRelease, *github.Response, error)) {
	fake.listReleasesMutex.Lock()
	defer fake.listReleasesMutex.Unlock()
	fake.ListReleasesStub = stub
}

func (fake *ReleasesLister) ListReleasesArgsForCall(i int) (context.Context, string, string, *github.ListOptions) {
	fake.listReleasesMutex.RLock()
	defer fake.listReleasesMutex.RUnlock()
...
func (fake *ReleasesLister) ListReleasesReturns(result1 []*github.RepositoryRelease, result2 *github.Response, result3 error) {
	fake.listReleasesMutex.Lock()
	defer fake.listReleasesMutex.Unlock()
...
func (fake *ReleasesLister) ListReleasesReturnsOnCall(i int, result1 []*github.RepositoryRelease, result2 *github.Response, result3 error) {
	fake.listReleasesMutex.Lock()
	defer fake.listReleasesMutex.Unlock()
	fake.ListReleasesStub = nil
...
func (fake *ReleasesLister) Invocations() map[string][][]interface{} {
...
func (fake *ReleasesLister) recordInvocation(key string, args []interface{}) {
...
var _ component.ReleasesLister = new(ReleasesLister)
