...
func (fake *GitHubRepositoryAPI) DownloadReleaseAsset(arg1 context.Context, arg2 string, arg3 string, arg4 int64, arg5 *http.Client) (io.ReadCloser, string, error) {
...
func (fake *GitHubRepositoryAPI) DownloadReleaseAssetCallCount() int {
...
func (fake *GitHubRepositoryAPI) DownloadReleaseAssetCalls(stub func(context.Context, string, string, int64, *http.Client) (io.ReadCloser, string, error)) {
	fake.downloadReleaseAssetMutex.Lock()
	defer fake.downloadReleaseAssetMutex.Unlock()
	fake.DownloadReleaseAssetStub = stub
}

func (fake *GitHubRepositoryAPI) DownloadReleaseAssetArgsForCall(i int) (context.Context, string, string, int64, *http.Client) {
	fake.downloadReleaseAssetMutex.RLock()
	defer fake.downloadReleaseAssetMutex.RUnlock()
...
func (fake *GitHubRepositoryAPI) DownloadReleaseAssetReturns(result1 io.ReadCloser, result2 string, result3 error) {
	fake.downloadReleaseAssetMutex.Lock()
	defer fake.downloadReleaseAssetMutex.Unlock()
...
func (fake *GitHubRepositoryAPI) DownloadReleaseAssetReturnsOnCall(i int, result1 io.ReadCloser, result2 string, result3 error) {
	fake.downloadReleaseAssetMutex.Lock()
	defer fake.downloadReleaseAssetMutex.Unlock()
	fake.DownloadReleaseAssetStub = nil
...
func (fake *GitHubRepositoryAPI) GetReleaseByTag(arg1 context.Context, arg2 string, arg3 string, arg4 string) (*github.RepositoryRelease, *github.Response, error) {
...
func (fake *GitHubRepositoryAPI) GetReleaseByTagCallCount() int {
	fake.getReleaseByTagMutex.RLock()
	defer fake.getReleaseByTagMutex.RUnlock()
	return len(fake.getReleaseByTagArgsForCall)
}

func (fake *GitHubRepositoryAPI) GetReleaseByTagCalls(stub func(context.Context, string, string, string) (*github.RepositoryRelease, *github.Response, error)) {
	fake.getReleaseByTagMutex.Lock()
	defer fake.getReleaseByTagMutex.Unlock()
	fake.GetReleaseByTagStub = stub
}

func (fake *GitHubRepositoryAPI) GetReleaseByTagArgsForCall(i int) (context.Context, string, string, string) {
	fake.getReleaseByTagMutex.RLock()
	defer fake.getReleaseByTagMutex.RUnlock()
...
func (fake *GitHubRepositoryAPI) GetReleaseByTagReturns(result1 *github.RepositoryRelease, result2 *github.Response, result3 error) {
	fake.getReleaseByTagMutex.Lock()
	defer fake.getReleaseByTagMutex.Unlock()
...
func (fake *GitHubRepositoryAPI) GetReleaseByTagReturnsOnCall(i int, result1 *github.RepositoryRelease, result2 *github.Response, result3 error) {
	fake.getReleaseByTagMutex.Lock()
	defer fake.getReleaseByTagMutex.Unlock()
	fake.GetReleaseByTagStub = nil
...
func (fake *GitHubRepositoryAPI) Invocations() map[string][][]interface{} {
...
func (fake *GitHubRepositoryAPI) recordInvocation(key string, args []interface{}) {
...
var _ component.GitHubRepositoryAPI = new(GitHubRepositoryAPI)
